...
@section('contenu')
    ...
    <section class="ftco-section">
    	<div class="container">
			...
			@if(request()->input())
			<h6>{{$produits->total()}} résultat(s) pour la recherche de "{{request()->q}}" </h6>

			@endif

			@include('include.search1')
    		...
    		<div class="row">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="/storage/produit_images/{{$produit->product_image}}" alt="Colorlib Template">
    					...
    					<div class="text py-3 pb-4 px-3 text-center">
	    					...
	    					<div class="bottom-area d-flex px-3">
	    						<div class="m-auto d-flex">
	    							<a href="/detail/{{$produit->id}}" class="add-to-cart d-flex justify-content-center align-items-center text-center">
